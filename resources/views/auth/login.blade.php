        ...
        <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login">
            <div
                            ...
                            <div class="kt-login__body">
                                ...
                                <div class="kt-login__signin">
                                    <div class="kt-login__head">
                                        <h3 class="kt-login__title" style="font-weight: bold; font-size: 2rem; font-family:sans-serif">Iniciar Sesión</h3>
                                    </div>
                                        ...
                                        <form method="POST" class="kt-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control placeholder-no-fix" type="text"
                                                    autocomplete="off" placeholder="Usuario" name="username" required style="font-weight: bold; font-size: 15px; font-family:sans-serif"/>
                                            </div>
                                            <div class="form-group">
                                                <input class="form-control form-control-last" type="password"
                                                    placeholder="Contraseña" name="password" required style="font-weight: bold; font-size: 15px; font-family:sans-serif">
                                            </div>
                                            ...
                                            <div class="kt-login__actions">
                                                <button id="kt_login_signin_submit"
                                                    class="btn btn-brand btn-pill btn-elevate" style="font-weight: bold; font-size: 15px; font-family:sans-serif">Entrar</button>
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content"
                    style="background-image: url(assets/media/bg/bg-2.jpg);  background-repeat: no-repeat; background-position: center; ">
                    <div class="kt-login__section">
                        <div class="kt-login__block">
                            <h3 class="kt-login__title">{{ config('app.name', 'Laravel') }}</h3>
                            <div class="kt-login__desc">
                                {{ config('app.title', ' SISTEMAS DE ADMINISTRACION') }}
