{{-- <link href="{{ asset('assets/vendors/	') }}" rel="stylesheet"> --}}
...
<link href="{{ asset('assets/vendors/custom/line-awesome/css/line-awesome.css') }}" rel="stylesheet" type="text/css" />
...
<link href="{{ URL::asset('assets/vendors/general/datetimepicker/bootstrap-datetimepicker.css')}}" rel="stylesheet" type="text/css" />
