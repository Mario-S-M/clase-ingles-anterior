...
<!--<script src="{{ URL::asset('assets/vendors/general/datetimepicker/bootstrap-datetimepicker.css')}}" type="text/javascript"></script>-->
<script src="{{ URL::asset('assets/vendors/general/datetimepicker/moment.min.js')}}" type="text/javascript"></script>
<script src="{{ URL::asset('assets/vendors/general/datetimepicker/bootstrap-datetimepicker.min.js')}}" type="text/javascript"></script>
